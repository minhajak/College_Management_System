...
<body>
    <div class="container">
        <div class="profile-card">
            <h2 class="text-center mb-4">Update Student Profile</h2>
            
            <form action="${pageContext.request.contextPath}/handleupdatestudent/${student.sid}" 
                  method="post" 
                ...
                <div class="form-group text-center">
                    <img id="imagePreview" class="image-preview"
                        src="${pageContext.request.contextPath}/student/${student.sid}"
                        alt="Current Image">
               ...
               <%--  <div class="row">
                ...
                <div class="form-group text-center mt-4">
                    ...
                    <a href="${pageContext.request.contextPath}/getstudent/${student.getSid()}" 
    ...
    <script>
        function previewImage(event) {
            ...
            if (file) {
                ...
                preview.src = "${pageContext.request.contextPath}/student/${student.sid}";
            }
        }
