		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<form action="${pageContext.request.contextPath}/handleteacher"
							...
							<div class="form-group">
								<input type="text" name="department.did"
									value="${department.getDid()}" hidden="">
							</div>
							<div class="form-group">
								<label for="subject">Subject:</label> <select id="subject"
									name="subject.sid" class="form-control" required>
									<option value="" disabled selected>Select a subject</option>
									<c:forEach var="subject" items="${subjects}">
										<option value="${subject.sid}">${subject.name}</option>
									</c:forEach>
								</select>
							</div>
							<div class="form-group text-center">
								...
								<a
									href="${pageContext.request.contextPath}/department/${department.getDname()}"
